        ...
        <div class="footer-wrap">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    $social_data = json_decode($settings -> social);
                    @endphp
                    <div class="footer-social">
                        <ul>
                            <li>
                                <a target="_blank" href="{{ $social_data -> fb}}"><i class="ti-facebook"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_data-> tw}}"><i class="ti-twitter-alt"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_data-> li}}"><i class="ti-linkedin"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_data-> in}}"><i class="ti-instagram"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_data-> dr}}"><i class="ti-dribbble"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
